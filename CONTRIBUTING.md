...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a
   build.
2. For branches, you have to branch off of Develop and name your branch as <type or purpose>/<name-of-branch> ie: `feature/sending-vap`. We have a couple of branch types based on the task: bug (for bug fixes), devop, and feature.
...
reported by contacting the project team at `dev@myvaporwallet[.]com`. All
